...
public class RelativizeTest01 {
    public static void main(String[] args) {
        ...
        Path classe = Paths.get("/home/davi/devbrabo/helloword.java");
        Path pathToClasse = dir.relativize(classe);
        System.out.println(pathToClasse);

        Path absoluto1 = Paths.get("/home/davi");
        Path absoluto2 = Paths.get("/usr/local");
        Path absoluto3 = Paths.get("/home/davi/devbrabo/helloword.java");
        Path relativo1 = Paths.get("temp");
        Path relativo2 = Paths.get("temp/temp.23665");
